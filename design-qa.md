...
- Implementation: local `http://127.0.0.1:8765/?screen=log-amount&build=summary-4`.
...
- `node pumping-summary.test.js`: passed; verifies total, duration, actual let-down counts, severe-leak notice, chart zone colors, and line-style legend.
